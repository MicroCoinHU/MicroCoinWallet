object CreateSubaccountForm: TCreateSubaccountForm
  Left = 0
  Top = 0
  ...
  object Label3: TLabel
    ...
    Width = 80
    Height = 13
    Caption = 'Daily spend limit:'
  end
  object edInitialBalance: TEdit
    Left = 20
    Top = 36
    Width = 121
    Height = 21
    ...
    TabOrder = 0
    OnKeyPress = edInitialBalanceKeyPress
  end
  object edBalanceLimit: TEdit
    Left = 164
    Top = 36
    Width = 121
    Height = 21
  ...
  object edPublicKey: TLabeledEdit
    Left = 20
    Top = 96
    Width = 409
    Height = 21
