object SettingsForm: TSettingsForm
  ...
  Caption = 'MicroCoin be'#225'll'#237't'#225'sok'
  ClientHeight = 335
  ClientWidth = 429
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object Label10: TLabel
        ...
        Width = 116
        Height = 13
        Caption = #201'rtes'#237't'#233'sek:'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object CheckBox1: TCheckBox
        ...
        Width = 116
        Height = 17
        Caption = 'Friss'#237't'#233'sek ellen'#337'rz'#233'se'
        Enabled = False
        TabOrder = 5
      end
      object CheckBox2: TCheckBox
        ...
        Width = 97
        Height = 17
        Caption = 'Auto friss'#237't'#233's'
        Enabled = False
        TabOrder = 6
      end
    end
    object MiningTab: TTabSheet
      ...
      object editMinerName: TLabeledEdit
        ...
        EditLabel.Width = 59
        EditLabel.Height = 13
        EditLabel.Caption = 'B'#225'ny'#225'sz neve:'
        TabOrder = 0
      end
      ...
      object Panel1: TPanel
        ...
        object radionewKey: TRadioButton
          ...
          Width = 276
          Height = 17
          Caption = 'Mindig '#250'j kulcsot haszn'#225'ljunk'
          TabOrder = 0
        ...
        object radioRandomkey: TRadioButton
          ...
          Width = 149
          Height = 17
          Caption = 'V'#233'letlenszer'#369' v'#225'laszt'#225's'
          TabOrder = 1
        ...
        object radiousethiskey: TRadioButton
          ...
          Width = 149
          Height = 17
          Caption = 'Mindig ezt a kulcsot haszn'#225'ld:'
          TabOrder = 2
    ...
    object NetOptions: TTabSheet
      ...
      object Label4: TLabel
        ...
        Width = 134
        Height = 13
        Caption = 'Enged'#233'lyzett kliens IP c'#237'mek:'
      end
      ...
      object checkEnableRPC: TCheckBox
        ...
        Width = 141
        Height = 17
        Caption = 'JSON-RPC enged'#233'lyez'#233'se'
        TabOrder = 1
      end
  ...
  object Panel2: TPanel
    ...
    object PngBitBtn1: TPngBitBtn
      ...
      Width = 127
      Height = 25
      Caption = 'Hely felszabad'#237't'#225'sa'
      TabOrder = 2
      Visible = False
      PngImage.Data = {
        89504E470D0A1A0A0000000D49484452000000100000001008060000001FF3FF
